...
export interface ApiWikiCategoryWikiCategory
  ...
  info: {
    description: 'Organize wiki pages into categories';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    pages: Schema.Attribute.Relation<'oneToMany', 'api::wiki-page.wiki-page'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWikiPageWikiPage extends Struct.CollectionTypeSchema {
  collectionName: 'wiki_pages';
  info: {
    description: 'WikiWonder wiki article with markdown content';
  ...
  attributes: {
    ...
    contentFormat: Schema.Attribute.Enumeration<['markdown', 'html']> &
    ...
    sourceType: Schema.Attribute.Enumeration<
      ['local', 'wikipedia', 'import', 'strapi']
    > &
      Schema.Attribute.DefaultTo<'strapi'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::wiki-page.wiki-page': ApiWikiPageWikiPage;
